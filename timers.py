...
def timers(update_volume, update_date, update_time, update_image, update_pauseplay, update_network, update_title, fetch_updates_async, scales, labels, buttons, images):
    ...
    GLib.timeout_add(500, update_title, buttons)
